...
<head>
  ...
  <link rel="icon" type="image/png" sizes="64x64" href="<?php echo get_stylesheet_directory_uri(); ?>/favicon.png">
  ...
  <meta name="msapplication-TileImage" content="<?php echo get_stylesheet_directory_uri(); ?>/windows-tile-144x144.png">
